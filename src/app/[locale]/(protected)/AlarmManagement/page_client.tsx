...
import AlertsTable from "./_components/table";
...
export default function AlertsPage() {
	...
	const [analyst, setAnalyst] = React.useState<string>("all");
		...
		<div className="px-6 py-6 space-y-4">
			...
			<div className="grid grid-cols-1 lg:grid-cols-[1.6fr_.8fr_.8fr_1fr_1fr_1fr] gap-4 items-end">
				...
				<div className="space-y-1">
					...
					<Select value={analyst} onValueChange={setAnalyst} disabled>
						<SelectTrigger className="border-black">
							<SelectValue placeholder="Todos los analistas" />
						</SelectTrigger>
						<SelectContent>
							<SelectItem value="all">Todos los analistas</SelectItem>
							<SelectItem value="Elena Rivas">Elena Rivas</SelectItem>
							<SelectItem value="María Velazco">María Velazco</SelectItem>
							<SelectItem value="Carlos Vera">Carlos Vera</SelectItem>
							<SelectItem value="Sin asignar">Sin asignar</SelectItem>
							<SelectItem value="Sistema (Auto)">Sistema (Auto)</SelectItem>
						</SelectContent>
					</Select>
				</div>
